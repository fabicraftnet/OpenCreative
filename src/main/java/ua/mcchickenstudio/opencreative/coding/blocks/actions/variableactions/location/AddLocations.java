...
public final class AddLocations extends VariableAction {

    public AddLocations(Executor executor, Target target, int x, Arguments args) {
    ...
    protected void execute() {
        ...
        setVarValue(result, first.clone().add(second));
    }

    @Override
    public @NotNull ActionType getActionType() { return ActionType.VAR_ADD_LOCATIONS; }
}
