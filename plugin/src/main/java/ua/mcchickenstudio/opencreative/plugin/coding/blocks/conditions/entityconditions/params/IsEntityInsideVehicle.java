...
public final class IsEntityInsideVehicle extends EntityCondition {
    public IsEntityInsideVehicle(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
