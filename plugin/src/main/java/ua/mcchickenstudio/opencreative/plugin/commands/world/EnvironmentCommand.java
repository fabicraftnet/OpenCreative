...
package ua.mcchickenstudio.opencreative.plugin.commands.world;
...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.world.JoinEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.world.LikeEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.world.PlayEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.world.QuitEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.world.other.GamePlayEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.PlanetExecutors;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.other.Function;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.other.Method;
import ua.mcchickenstudio.opencreative.plugin.coding.prompters.PrompterBadCodeException;
import ua.mcchickenstudio.opencreative.plugin.coding.prompters.PrompterDownException;
import ua.mcchickenstudio.opencreative.plugin.coding.prompters.PrompterLimitedException;
import ua.mcchickenstudio.opencreative.plugin.coding.prompters.UnauthorizedPrompterException;
...
import ua.mcchickenstudio.opencreative.plugin.coding.variables.WorldVariable;
import ua.mcchickenstudio.opencreative.plugin.commands.CommandHandler;
import ua.mcchickenstudio.opencreative.plugin.menus.world.settings.WorldEnvironmentMenu;
...
import static ua.mcchickenstudio.opencreative.plugin.utils.CooldownUtils.CooldownType;
import static ua.mcchickenstudio.opencreative.plugin.utils.CooldownUtils.checkAndSetCooldownWithMessage;
import static ua.mcchickenstudio.opencreative.plugin.utils.ErrorUtils.*;
            ...
            switch (args[0].toLowerCase()) {
                case "vars", "variables", "var":
                    ...
                    if (args[1].equalsIgnoreCase("size")) {
                        ...
                        Component navigation = (getLocaleMessage("environment.variables.list.navigation"));
                        page += 1;
                        if (page * 20 > 20) {
                            navigation = navigation.append((getLocaleMessage("environment.variables.list.previous-page")).clickEvent(ClickEvent.runCommand("/environment variables list " + (page - 1))));
                        }
                        if (allVariables.size() > current) {
                            navigation = navigation.append((getLocaleMessage("environment.variables.list.next-page")).clickEvent(ClickEvent.runCommand("/environment variables list " + (page + 1))));
                        }
                        if (!(getLocaleMessage("environment.variables.list.navigation")).equals(navigation)) {
