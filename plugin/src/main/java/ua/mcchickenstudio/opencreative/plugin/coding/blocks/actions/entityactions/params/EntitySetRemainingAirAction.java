...
public final class EntitySetRemainingAirAction extends EntityAction {
    public EntitySetRemainingAirAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        if (!add) {
            ...
            livingEntity.setRemainingAir(livingEntity.getRemainingAir() + ticks);
        }
    }
