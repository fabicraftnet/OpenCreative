...
public final class IsEntityInRain extends EntityCondition {
    public IsEntityInRain(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
