...
public final class IsEntityMob extends EntityCondition {
    public IsEntityMob(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
