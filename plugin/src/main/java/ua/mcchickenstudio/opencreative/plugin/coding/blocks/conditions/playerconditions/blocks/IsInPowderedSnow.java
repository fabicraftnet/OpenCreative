...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.blocks;
...
public final class IsInPowderedSnow extends PlayerCondition {
    public IsInPowderedSnow(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_PLAYER_IS_IN_POWDERED_SNOW;
    }
}
