...
public final class EntitySetShieldBlockingDelay extends EntityAction {
    public EntitySetShieldBlockingDelay(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        livingEntity.setShieldBlockingDelay(delay);
    }
