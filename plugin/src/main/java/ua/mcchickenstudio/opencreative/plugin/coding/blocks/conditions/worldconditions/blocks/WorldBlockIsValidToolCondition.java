...
public final class WorldBlockIsValidToolCondition extends WorldCondition {

    public WorldBlockIsValidToolCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
