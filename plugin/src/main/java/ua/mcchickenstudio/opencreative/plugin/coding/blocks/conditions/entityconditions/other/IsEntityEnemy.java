...
public final class IsEntityEnemy extends EntityCondition {
    public IsEntityEnemy(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_ENTITY_IS_ENEMY;
    }
}
