...
package ua.mcchickenstudio.opencreative.plugin.indev.blocks.actions;
...
import ua.mcchickenstudio.opencreative.plugin.indev.blocks.WrappedActionBlock;

public class WrappedAction extends WrappedActionBlock<ActionBlock>  {

    public WrappedAction(@NotNull ActionBlock actionBlock, @NotNull Target target, @NotNull Arguments arguments, int x, int y, int z) {
        super(actionBlock,target,arguments,x,y,z);
    }

    @Override
    public void execute(@Nullable Entity target, @NotNull ActionsHandler actionsHandler) {
        codingBlock.execute(target, actionsHandler, arguments);
    }
