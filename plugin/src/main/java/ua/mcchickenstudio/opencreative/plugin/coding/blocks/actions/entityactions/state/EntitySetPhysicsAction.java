...
public final class EntitySetPhysicsAction extends EntityAction {
    public EntitySetPhysicsAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        entity.setNoPhysics(!value);
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_PHYSICS;
    }
}
