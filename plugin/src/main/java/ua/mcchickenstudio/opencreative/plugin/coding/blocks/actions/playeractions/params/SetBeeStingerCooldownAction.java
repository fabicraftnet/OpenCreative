...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.params;
...
public final class SetBeeStingerCooldownAction extends PlayerAction {
    public SetBeeStingerCooldownAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.PLAYER_SET_BEE_STINGER_COOLDOWN;
    }
}
