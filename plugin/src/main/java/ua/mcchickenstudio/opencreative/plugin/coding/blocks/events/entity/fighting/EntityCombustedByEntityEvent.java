...
public final class EntityCombustedByEntityEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final EntityCombustByEntityEvent event;

    public EntityCombustedByEntityEvent(EntityCombustByEntityEvent event) {
