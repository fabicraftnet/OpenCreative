...
package ua.mcchickenstudio.opencreative.plugin.listeners.entity;
...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.fighting.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.interaction.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.movement.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.state.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.movement.EnteredVehicleEvent;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.movement.PlayerVehicleExitEvent;
...
import static ua.mcchickenstudio.opencreative.plugin.utils.MessageUtils.getLocaleComponent;
...
public final class EntityStateListener implements Listener {
    ...
    public void onWitchReady(WitchReadyPotionEvent event) {
        Planet planet = OpenCreative.getPlanetsManager().getPlanetByWorld(event.getEntity().getWorld());
        if (planet != null)
            new ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.state.WitchReadyPotionEvent(event).callEvent();
    }
