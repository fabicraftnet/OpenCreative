...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors;
...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.DisplayableIcon;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.entity.EntityExecutor;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.entity.fighting.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.entity.interaction.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.entity.movement.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.entity.state.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.other.Cycle;
...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.PlayerExecutor;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.fighting.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.interaction.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.movement.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.player.world.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.world.WorldExecutor;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.world.blocks.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.world.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.executors.world.other.*;
 ...
 * extends one of prepared: {@link PlayerExecutor PlayerExecutor},
 * {@link WorldExecutor WorldExecutor},
 * {@link EntityExecutor EntityExecutor}, and register it with
