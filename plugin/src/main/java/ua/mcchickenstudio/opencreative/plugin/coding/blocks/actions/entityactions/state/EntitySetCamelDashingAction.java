...
public final class EntitySetCamelDashingAction extends EntityAction {
    public EntitySetCamelDashingAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_CAMEL_DASHING;
    }
}
