...
public final class EntitySetBeeStingerCooldownAction extends EntityAction {
    public EntitySetBeeStingerCooldownAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        livingEntity.setBeeStingerCooldown(cooldown);
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_BEE_STINGER_COOLDOWN;
    }
}
