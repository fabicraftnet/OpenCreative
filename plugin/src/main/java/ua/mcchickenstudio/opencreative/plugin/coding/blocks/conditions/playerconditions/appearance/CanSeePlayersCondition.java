...
public final class CanSeePlayersCondition extends PlayerCondition {
     ...
     */
    public CanSeePlayersCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_PLAYER_CAN_SEE_PLAYER;
    }
}
