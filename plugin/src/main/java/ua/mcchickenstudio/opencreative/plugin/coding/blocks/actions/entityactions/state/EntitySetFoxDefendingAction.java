...
public final class EntitySetFoxDefendingAction extends EntityAction {
    public EntitySetFoxDefendingAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_FOX_DEFENDING;
    }
}
