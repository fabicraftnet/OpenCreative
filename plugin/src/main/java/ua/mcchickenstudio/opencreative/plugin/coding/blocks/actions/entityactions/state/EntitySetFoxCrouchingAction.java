...
public final class EntitySetFoxCrouchingAction extends EntityAction {
    public EntitySetFoxCrouchingAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        fox.setCrouching(value);
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_FOX_CROUCHING;
    }
}
