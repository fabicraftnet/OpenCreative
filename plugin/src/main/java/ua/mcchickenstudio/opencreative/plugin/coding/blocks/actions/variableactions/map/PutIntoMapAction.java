...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.map;
...
import ua.mcchickenstudio.opencreative.plugin.coding.exceptions.CollectionWithCollectionException;
...
public final class PutIntoMapAction extends VariableAction {
    public PutIntoMapAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.VAR_PUT_INTO_MAP;
    }
}
