...
import ua.mcchickenstudio.opencreative.plugin.coding.values.events.BlockMaterialValue;

import java.util.List;

public final class IsBlockEqualsCondition extends PlayerCondition {
