...
public final class EntitySetFoxFaceplantedAction extends EntityAction {
    public EntitySetFoxFaceplantedAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        fox.setFaceplanted(value);
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_FOX_FACEPLANTED;
    }
}
