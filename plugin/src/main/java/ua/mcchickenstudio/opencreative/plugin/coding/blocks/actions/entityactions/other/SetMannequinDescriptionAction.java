...
public final class SetMannequinDescriptionAction extends EntityAction {
    public SetMannequinDescriptionAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        if (((TextComponent) text).content().isEmpty())
        {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_MANNEQUIN_DESCRIPTION;
    }
}
