...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.inventory;
...
public final class UndiscoverRecipeAction extends PlayerAction {
    public UndiscoverRecipeAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.PLAYER_UNDISCOVER_RECIPE;
    }
}
