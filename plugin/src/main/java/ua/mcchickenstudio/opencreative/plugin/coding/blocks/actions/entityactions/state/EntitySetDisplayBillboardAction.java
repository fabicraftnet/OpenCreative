...
public final class EntitySetDisplayBillboardAction extends EntityAction {
    public EntitySetDisplayBillboardAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_DISPLAY_BILLBOARD;
    }
}
