...
public final class IsFlyingCondition extends PlayerCondition {
    public IsFlyingCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_PLAYER_IS_FLYING;
    }
}
