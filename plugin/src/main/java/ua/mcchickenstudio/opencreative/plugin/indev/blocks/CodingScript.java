...
package ua.mcchickenstudio.opencreative.plugin.indev.blocks;
...
import ua.mcchickenstudio.opencreative.plugin.indev.blocks.executors.ExecutorBlock;
import ua.mcchickenstudio.opencreative.plugin.indev.blocks.executors.WrappedExecutor;
...
import static ua.mcchickenstudio.opencreative.plugin.utils.ErrorUtils.sendPlanetErrorMessage;
import static ua.mcchickenstudio.opencreative.plugin.utils.FileUtils.getPlanetScriptFile;
...
public class CodingScript {
    ...
    public boolean load() {
        ...
        long totalSize = FileUtils.getFileSize(scriptFile);
        ...
        if (totalSize > limit) {
            sendPlanetErrorMessage(planet, getLocaleMessageString("world.script-size-limit")
                    .replace("%amount%", org.apache.commons.io.FileUtils.byteCountToDisplaySize(totalSize))
