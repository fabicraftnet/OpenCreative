...
public final class EntitySetHookApplyLureAction extends EntityAction {
    public EntitySetHookApplyLureAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        if (entity instanceof FishHook hook) {
            hook.setApplyLure(value);
        } else {
            throw new UnsupportedEntityException(FishHook.class, entity);
        }
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_HOOK_APPLY_LURE;
    }
}
