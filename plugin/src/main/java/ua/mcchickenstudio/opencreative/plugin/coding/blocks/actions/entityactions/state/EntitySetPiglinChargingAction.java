...
public final class EntitySetPiglinChargingAction extends EntityAction {
    public EntitySetPiglinChargingAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_PIGLIN_CROSSBOW;
    }
}
