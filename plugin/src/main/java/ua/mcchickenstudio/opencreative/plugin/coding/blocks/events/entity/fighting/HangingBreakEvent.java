...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.fighting;
...
public final class HangingBreakEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final HangingBreakByEntityEvent event;

    public HangingBreakEvent(HangingBreakByEntityEvent event) {
