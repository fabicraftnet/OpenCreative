...
public final class HasItemCooldownCondition extends PlayerCondition {

    public HasItemCooldownCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
