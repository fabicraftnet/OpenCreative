...
public final class EntityMountedEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final EntityMountEvent event;

    public EntityMountedEvent(EntityMountEvent event) {
