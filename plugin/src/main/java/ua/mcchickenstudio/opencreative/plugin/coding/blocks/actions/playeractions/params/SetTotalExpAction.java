...
public final class SetTotalExpAction extends PlayerAction {
    public SetTotalExpAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.PLAYER_SET_TOTAL_EXPERIENCE;
    }
}
