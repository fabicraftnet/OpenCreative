...
public final class EntitySetAdultAction extends EntityAction {
    public EntitySetAdultAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_ADULT;
    }
}
