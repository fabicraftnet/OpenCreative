...
public final class EnteredVehicleEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final VehicleEnterEvent event;

    public EnteredVehicleEvent(Player player, VehicleEnterEvent event) {
        super(player);
        this.event = event;
    }
