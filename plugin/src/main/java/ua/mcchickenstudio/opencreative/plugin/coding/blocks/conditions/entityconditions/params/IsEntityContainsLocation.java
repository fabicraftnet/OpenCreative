...
public final class IsEntityContainsLocation extends EntityCondition {
    public IsEntityContainsLocation(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_ENTITY_CONTAINS_LOCATION;
    }
}
