...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions;
...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.CodingBlockType;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.controlactions.events.CancelEventAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.controlactions.events.UncancelEventAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.controlactions.lines.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.controlleractions.other.CatchErrorAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.controlleractions.other.MeasureTimeAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.movement.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.other.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.params.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.state.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.other.LaunchFunctionAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.other.LaunchMethodAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.appearance.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.communication.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.movement.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.params.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.playeractions.state.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.repeatactions.other.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.selectionactions.SelectionAddTargetAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.selectionactions.SelectionRemoveTargetAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.selectionactions.SelectionSetTargetAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.item.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.list.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.location.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.map.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.number.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.other.DeleteVariableAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.other.GetVariableTypeAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.other.SetVariableRandomValueAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.other.SetVariableValueAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.text.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.variableactions.vector.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.appearance.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.blocks.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.entity.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.world.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.world.phys.AddPhysObjectAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.world.phys.MotionParamPhysObjectAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.world.phys.SettingsParamPhysObjectAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.worldactions.world.phys.VisualParamPhysObjectAction;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.entityconditions.other.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.entityconditions.params.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.appearance.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.blocks.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.inventory.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.params.HasPotionEffectsCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.params.MessageEqualsCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.params.PlayerNameEqualsCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.state.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.item.VarItemHasCustomData;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.item.VarItemHasCustomKey;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.item.VarItemHasEnchantments;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.list.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.location.LocationInAreaCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.number.NumberGreaterCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.number.NumberInRangeCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.number.NumberLessCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.other.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.text.TextContainsCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.text.TextEndsWithCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.text.TextEqualsCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.text.TextStartsWithCondition;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.worldconditions.blocks.*;
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.worldconditions.world.*;
import ua.mcchickenstudio.opencreative.plugin.coding.menus.MenusCategory;
import ua.mcchickenstudio.opencreative.plugin.coding.menus.layouts.ArgumentSlot;
import ua.mcchickenstudio.opencreative.plugin.coding.menus.layouts.ParameterSlot;
...
import static ua.mcchickenstudio.opencreative.plugin.utils.BlockUtils.getSignLine;
...
public enum ActionType implements CodingBlockType {
    ...
    PLAYER_SET_SPECTATOR_TARGET(
            ActionCategory.PLAYER_ACTION,
            MenusCategory.MOVEMENT,
            SetSpectatorTargetAction.class,
            Material.SKELETON_SKULL,
            new ArgumentSlot("entity", ValueType.TEXT)
    ),
    ...
    IF_PLAYER_IS_UNDERWATER(ActionCategory.PLAYER_CONDITION, MenusCategory.MOVEMENT, IsUnderWater.class, Material.BLUE_STAINED_GLASS),
    IF_PLAYER_IS_IN_RAIN(ActionCategory.PLAYER_CONDITION, MenusCategory.MOVEMENT, IsInRain.class, Material.WATER_BUCKET),
    IF_PLAYER_IS_IN_LAVA(ActionCategory.PLAYER_CONDITION, MenusCategory.MOVEMENT, IsInLava.class, Material.LAVA_BUCKET),
    ...
    IF_PLAYER_IS_INVENTORY_OWN(ActionCategory.PLAYER_CONDITION, MenusCategory.INVENTORY, IsClickedInOwnInventoryCondition.class, Material.PLAYER_HEAD),
    ...
    IF_PLAYER_IS_IN_TEAM(ActionCategory.PLAYER_CONDITION, MenusCategory.STATE, IsPlayerInTeam.class, Material.LIME_BANNER, new ArgumentSlot("scoreboard", ValueType.TEXT), new ArgumentSlot("team", ValueType.TEXT)),
    IF_PLAYER_IS_DEAD(ActionCategory.PLAYER_CONDITION, MenusCategory.STATE, IsPlayerDead.class, Material.REDSTONE),
    ...
    WORLD_ADD_FURNACE_RECIPE(ActionCategory.WORLD_ACTION, MenusCategory.WORLD, AddFurnaceRecipeAction.class, Material.FURNACE, new ArgumentSlot("item", ValueType.ITEM), new ArgumentSlot("result", ValueType.ITEM), new ArgumentSlot("name", ValueType.TEXT), new ArgumentSlot("time", ValueType.NUMBER), new ArgumentSlot("experience", ValueType.NUMBER), new ParameterSlot("category", List.of("food", "building", "misc"), Material.PORKCHOP, Material.STONE, Material.LAVA_BUCKET)),
    ...
    VAR_GET_ITEM_BOOK_OWNER(ActionCategory.VARIABLE_ACTION, MenusCategory.ITEM_OPERATIONS, GetItemBookOwnerAction.class, Material.WRITABLE_BOOK, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("item", ValueType.ITEM)),
    VAR_GET_ITEM_ID(ActionCategory.VARIABLE_ACTION, MenusCategory.ITEM_OPERATIONS, GetItemIdAction.class, Material.NAME_TAG, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("item", ValueType.ITEM)),
    ...
    VAR_BUNDLE_ADD_ITEM(ActionCategory.VARIABLE_ACTION, MenusCategory.ITEM_OPERATIONS, BundleAddItemAction.class, Material.BUNDLE, new ArgumentSlot("items", ValueType.ITEM, (byte) 18), new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("bundle", ValueType.ITEM)),
    VAR_BUNDLE_GET_ITEMS(ActionCategory.VARIABLE_ACTION, MenusCategory.ITEM_OPERATIONS, BundleGetItemsAction.class, Material.BUNDLE, new ArgumentSlot("variable", ValueType.VARIABLE), new ArgumentSlot("bundle", ValueType.ITEM)),
    ...
    VAR_GET_VECTOR_ALL(
            ActionCategory.VARIABLE_ACTION,
            MenusCategory.VECTOR_OPERATIONS,
            GetVectorAllAction.class,
            Material.PRISMARINE_SHARD,
            new ArgumentSlot("target", ValueType.VECTOR),
            new ArgumentSlot("x", ValueType.VARIABLE),
            new ArgumentSlot("y", ValueType.VARIABLE),
            new ArgumentSlot("z", ValueType.VARIABLE)
    ),
    ...
    ENTITY_SET_DISPLAY_ROTATION(ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetDisplayRotationAction.class, Material.ENDER_EYE, new ArgumentSlot("x", ValueType.NUMBER), new ArgumentSlot("y", ValueType.NUMBER), new ArgumentSlot("z", ValueType.NUMBER), new ParameterSlot("add"), new ParameterSlot("side")),
    ...
    ENTITY_SET_DISPLAY_BACKGROUND(ActionCategory.ENTITY_ACTION, MenusCategory.ENTITY_STATE, EntitySetDisplayBackgroundAction.class, Material.BLACK_STAINED_GLASS, new ArgumentSlot("text", ValueType.TEXT)),
    ...
    IF_WORLD_ENTITY_EXISTS(ActionCategory.WORLD_CONDITION, MenusCategory.WORLD, IsWorldEntityInWorldCondition.class, Material.CHICKEN_SPAWN_EGG, new ArgumentSlot("entities", ValueType.ANY, (byte) 18), new ParameterSlot("all")),
    ...
    IF_ENTITY_IS_IN_POWDERED_SNOW(ActionCategory.ENTITY_CONDITION, MenusCategory.ENTITY_INTERACTION, IsEntityInPowderedSnow.class, Material.POWDER_SNOW_BUCKET),
