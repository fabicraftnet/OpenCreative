...
public final class EntityVillagerZombifyAction extends EntityAction {
    public EntityVillagerZombifyAction(Executor executor, Target target, int x, Arguments args) {
