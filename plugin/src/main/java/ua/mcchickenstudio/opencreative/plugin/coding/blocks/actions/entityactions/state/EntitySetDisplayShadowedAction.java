...
public final class EntitySetDisplayShadowedAction extends EntityAction {
    public EntitySetDisplayShadowedAction(Executor executor, Target target, int x, Arguments args) {
