...
public final class EntityVehicleDamageEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final VehicleDamageEvent event;

    public EntityVehicleDamageEvent(VehicleDamageEvent event) {
