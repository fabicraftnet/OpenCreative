...
public final class NumberLessCondition extends VariableCondition {
    public NumberLessCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
