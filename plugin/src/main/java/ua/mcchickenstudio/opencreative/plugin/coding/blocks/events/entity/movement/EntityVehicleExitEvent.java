...
public final class EntityVehicleExitEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final VehicleExitEvent event;

    public EntityVehicleExitEvent(VehicleExitEvent event) {
        super(event.getExited());
        this.event = event;
    }
