...
public final class EntitySetAIAction extends EntityAction {
    public EntitySetAIAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_AI;
    }
}
