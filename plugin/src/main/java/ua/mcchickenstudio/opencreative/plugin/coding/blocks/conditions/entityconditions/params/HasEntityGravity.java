...
public final class HasEntityGravity extends EntityCondition {
    public HasEntityGravity(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_ENTITY_HAS_GRAVITY;
    }
}
