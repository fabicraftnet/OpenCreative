...
public final class DistanceVectorAction extends VariableAction {
    public DistanceVectorAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.VAR_DISTANCE_VECTOR;
    }
}
