...
public final class EntitySetBeeStingersInBodyAction extends EntityAction {
    public EntitySetBeeStingersInBodyAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_BEE_STINGERS_IN_BODY;
    }
}
