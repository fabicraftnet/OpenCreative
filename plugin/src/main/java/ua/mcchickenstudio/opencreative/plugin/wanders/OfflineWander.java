...
package ua.mcchickenstudio.opencreative.plugin.wanders;
...
import ua.mcchickenstudio.opencreative.plugin.indev.Links;

import java.io.*;
import java.util.*;

import static ua.mcchickenstudio.opencreative.plugin.utils.ErrorUtils.sendDebugError;
import static ua.mcchickenstudio.opencreative.plugin.utils.FileUtils.getWanderJsonFile;
