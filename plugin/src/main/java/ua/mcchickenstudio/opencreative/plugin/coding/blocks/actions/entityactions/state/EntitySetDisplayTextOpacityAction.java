...
public final class EntitySetDisplayTextOpacityAction extends EntityAction {
    public EntitySetDisplayTextOpacityAction(Executor executor, Target target, int x, Arguments args) {
