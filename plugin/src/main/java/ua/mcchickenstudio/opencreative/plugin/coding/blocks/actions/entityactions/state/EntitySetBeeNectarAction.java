...
public final class EntitySetBeeNectarAction extends EntityAction {
    public EntitySetBeeNectarAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_BEE_NECTAR;
    }
}
