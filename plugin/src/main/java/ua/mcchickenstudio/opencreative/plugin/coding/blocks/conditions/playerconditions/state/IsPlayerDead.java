...
public final class IsPlayerDead extends PlayerCondition {
    public IsPlayerDead(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
