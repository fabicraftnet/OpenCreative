...
public final class IsTimeRelativeCondition extends PlayerCondition {
    /**
     ...
     */
    public IsTimeRelativeCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_PLAYER_IS_TIME_RELATIVE;
    }
}
