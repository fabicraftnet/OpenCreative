...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.player.movement;
...
public final class PlayerVehicleExitEvent extends WorldEvent implements Cancellable, KillerVictimEvent {

    private final VehicleExitEvent event;

    public PlayerVehicleExitEvent(Player player, VehicleExitEvent event) {
        super(player);
        this.event = event;
    }
