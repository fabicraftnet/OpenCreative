...
public final class RemoveRecipeAction extends WorldAction {

    public RemoveRecipeAction(Executor executor, Target target, int x, Arguments args) {
    ...
    protected void execute() {
        ...
        for (String recipe : recipes) {
            getPlanet().getTerritory().getRecipes().removeRecipe(recipe);
        }
    }

    @Override
    public @NotNull ActionType getActionType() {
        return ActionType.WORLD_REMOVE_RECIPE;
    }
}
