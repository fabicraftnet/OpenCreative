...
public final class IsSneakingCondition extends PlayerCondition {
    /**
     ...
     */
    public IsSneakingCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
