...
public final class ClearScoreboardScoresAction extends WorldAction {
    public ClearScoreboardScoresAction(Executor executor, Target target, int x, Arguments args) {
    ...
    protected void execute() {
        ...
        for (String name : scoreboards) {
            ...
            if (scoreboard != null) {
                getPlanet().getTerritory().getScoreboards().clearScores(scoreboard);
            }
        }
    }
