...
public final class IsEntityDisplay extends EntityCondition {
    public IsEntityDisplay(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_ENTITY_IS_DISPLAY;
    }
}
