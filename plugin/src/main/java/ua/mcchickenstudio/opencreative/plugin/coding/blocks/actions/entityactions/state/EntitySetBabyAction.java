...
public final class EntitySetBabyAction extends EntityAction {
    public EntitySetBabyAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_BABY;
    }
}
