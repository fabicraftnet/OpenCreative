...
package ua.mcchickenstudio.opencreative.plugin.coding.values;
...
import ua.mcchickenstudio.opencreative.plugin.coding.values.attributes.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.entity.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.events.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.human.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.living.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.player.*;
import ua.mcchickenstudio.opencreative.plugin.coding.values.world.*;
