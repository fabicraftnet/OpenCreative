...
public final class IsNearLocationCondition extends PlayerCondition {

    public IsNearLocationCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
