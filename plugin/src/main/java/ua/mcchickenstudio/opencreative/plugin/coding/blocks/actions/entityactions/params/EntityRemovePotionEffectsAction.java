...
public final class EntityRemovePotionEffectsAction extends EntityAction {
    public EntityRemovePotionEffectsAction(Executor executor, Target target, int x, Arguments args) {
