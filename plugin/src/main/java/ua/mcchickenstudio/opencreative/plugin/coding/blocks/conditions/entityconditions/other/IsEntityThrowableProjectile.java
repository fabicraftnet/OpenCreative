...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.entityconditions.other;
...
public final class IsEntityThrowableProjectile extends EntityCondition {
    public IsEntityThrowableProjectile(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_ENTITY_IS_THROWABLE_PROJECTILE;
    }
}
