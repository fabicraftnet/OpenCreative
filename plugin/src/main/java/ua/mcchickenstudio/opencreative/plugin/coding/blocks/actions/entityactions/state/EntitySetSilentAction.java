...
public final class EntitySetSilentAction extends EntityAction {
    public EntitySetSilentAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_SITTING;
    }
}
