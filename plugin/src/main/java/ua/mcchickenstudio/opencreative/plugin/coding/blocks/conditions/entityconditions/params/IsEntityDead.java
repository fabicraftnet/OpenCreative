...
public final class IsEntityDead extends EntityCondition {
    public IsEntityDead(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
