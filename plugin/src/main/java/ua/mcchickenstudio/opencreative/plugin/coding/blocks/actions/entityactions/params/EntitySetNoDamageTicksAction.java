...
public final class EntitySetNoDamageTicksAction extends EntityAction {
    public EntitySetNoDamageTicksAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public void executeEntity(@NotNull Entity entity) {
        ...
        if (add) {
            ticks = ticks + livingEntity.getNoDamageTicks();
        }
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_NO_DAMAGE_TICKS;
    }
}
