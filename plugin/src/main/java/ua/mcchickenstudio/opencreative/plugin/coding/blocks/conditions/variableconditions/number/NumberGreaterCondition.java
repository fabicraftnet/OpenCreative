...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.variableconditions.number;
...
public final class NumberGreaterCondition extends VariableCondition {
    public NumberGreaterCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
