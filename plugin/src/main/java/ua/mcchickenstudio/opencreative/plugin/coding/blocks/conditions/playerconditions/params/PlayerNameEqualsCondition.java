...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.conditions.playerconditions.params;
...
public final class PlayerNameEqualsCondition extends PlayerCondition {

    public PlayerNameEqualsCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
