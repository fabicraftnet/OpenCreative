...
public final class SetBeeStingersInBodyAction extends PlayerAction {
    public SetBeeStingersInBodyAction(Executor executor, Target target, int x, Arguments args) {
