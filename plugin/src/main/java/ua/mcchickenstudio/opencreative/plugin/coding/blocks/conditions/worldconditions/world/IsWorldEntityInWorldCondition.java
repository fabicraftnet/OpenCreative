...
public final class IsWorldEntityInWorldCondition extends WorldCondition {

    public IsWorldEntityInWorldCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.IF_WORLD_ENTITY_EXISTS;
    }
}
