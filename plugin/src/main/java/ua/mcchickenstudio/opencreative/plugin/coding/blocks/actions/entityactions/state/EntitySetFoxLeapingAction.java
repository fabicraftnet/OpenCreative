...
public final class EntitySetFoxLeapingAction extends EntityAction {
    public EntitySetFoxLeapingAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_FOX_LEAPING;
    }
}
