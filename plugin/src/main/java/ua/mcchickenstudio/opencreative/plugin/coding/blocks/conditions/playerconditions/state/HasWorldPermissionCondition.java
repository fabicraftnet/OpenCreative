...
public final class HasWorldPermissionCondition extends PlayerCondition {

    public HasWorldPermissionCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
