...
import ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.world.other.LimitReachedEntitiesEvent;
...
public final class EntitySpawnListener implements Listener {
    ...
    public void onEntitySpawn(EntitySpawnEvent event) {
        ...
        if (planet != null) {
            ...
            new ua.mcchickenstudio.opencreative.plugin.coding.blocks.events.entity.entities.EntitySpawnEvent(event).callEvent();
        }
    }
