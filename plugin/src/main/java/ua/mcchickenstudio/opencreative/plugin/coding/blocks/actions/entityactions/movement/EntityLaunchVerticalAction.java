...
package ua.mcchickenstudio.opencreative.plugin.coding.blocks.actions.entityactions.movement;
...
public final class EntityLaunchVerticalAction extends EntityAction {
    public EntityLaunchVerticalAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_LAUNCH_VERTICAL;
    }
}
