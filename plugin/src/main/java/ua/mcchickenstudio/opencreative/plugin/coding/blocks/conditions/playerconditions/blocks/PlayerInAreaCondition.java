...
public final class PlayerInAreaCondition extends PlayerCondition {
    public PlayerInAreaCondition(Executor executor, Target target, int x, Arguments args, List<Action> actions, List<Action> reactions, boolean isOpposed) {
