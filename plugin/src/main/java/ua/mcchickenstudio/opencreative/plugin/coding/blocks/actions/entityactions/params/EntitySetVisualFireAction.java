...
public final class EntitySetVisualFireAction extends EntityAction {
    public EntitySetVisualFireAction(Executor executor, Target target, int x, Arguments args) {
    ...
    public @NotNull ActionType getActionType() {
        return ActionType.ENTITY_SET_VISUAL_FIRE;
    }
}
